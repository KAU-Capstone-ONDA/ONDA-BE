...
public class HotelRestController {
    ...
    @PostMapping("/competing-hotel/{hotelId}")
    @ResponseStatus(HttpStatus.OK)
    public ResponseDTO<List<HotelResponse>> postCompetingHotel(@PathVariable Long hotelId,
        @RequestBody @Valid
        CompetingHotelRequest request) {
        return ResponseDTO.res(hotelService.registerCompetingHotel(hotelId, request),
            "경쟁 호텔 등록에 성공했습니다.");
    }
