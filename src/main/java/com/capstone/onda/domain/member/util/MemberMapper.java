...
public class MemberMapper {
    ...
    public static Member toMember(MemberSignUpRequest memberSignUpRequest, Hotel hotel) {
        return Member.builder()
            .userEmail(memberSignUpRequest.email())
            .userNickName(memberSignUpRequest.name())
            .providerType(ProviderType.toProviderType(memberSignUpRequest.provider()))
